const contractAddress = "0x524411613DE7427d3EfdcAF5de29119a7CC93511"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the CovidKongz NFT Project!!";
